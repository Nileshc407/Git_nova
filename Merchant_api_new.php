<?php 
error_reporting(0);
class Merchant_api_new extends CI_Controller 
{
									...
									if($Voucher_result != Null)
									{
										...
										{	
												...
												{ 
													...
													if($ItemDetails !=NULL)
													{
														...
														else
														{
															...
															$data76['Enrollment_id'] = $Cust_enrollement_id;
															$data76['Item_code'] = $ItemCode;
															$data76['Item_qty'] = $item['Item_Qty'];
															$data76['Item_price'] = $item['Item_Rate'];
															
															$this->Merchant_api_model->insert_item($data76);
														}
											...
											/**********************stamp new logic 02-05-2021**************************/
												...
												$delete_temp_cart = $this->Merchant_api_model->delete_pos_temp_cart_data($Company_id,$Cust_enrollement_id);
					...
					{ 
						...
						if($Pos_trans_type ==1)
						{
							...
							if($cust_details !=NULL)
							{
								...
								{
									$Customer_enroll_id=$row25['Enrollement_id'];
									$Cust_enrollement_id=$row25['Enrollement_id'];
									$CardId=$row25['Card_id'];
									$fname=$row25['First_name'];
									$midlename=$row25['Middle_name'];
									$lname=$row25['Last_name'];
